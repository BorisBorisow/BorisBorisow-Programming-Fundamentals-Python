...
questions = ["Кога е основана България", "Колко е 2 * 2?", "Коя е най-голямата по площ страна в света?"]
guess_counter = 0
answered_questions = []
...
for _ in range (10):
    ...
    elif current_question == "Коя е най-голямата по площ страна в света?":
        answer = input("Моля въведете отговор: ")
